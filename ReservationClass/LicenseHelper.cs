...
namespace ReservationClass
{
    public class LicenseHelper
    {
        ...
        public LicenseHelper(string key)
        {
            privateKey = key;
        }

        public static void GenerateNewKeyPair(string privateFilePath, string publicFilePath)
        {
            string withSecret;
            string woSecret;
            ...
            File.WriteAllText(privateFilePath, withSecret);
            File.WriteAllText(publicFilePath, woSecret);
        }
